    ...
    <nav className={cn(
      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="bg-white text-black px-5 py-2 rounded-full text-sm font-semibold hover:bg-gray-200 transition-colors flex items-center gap-2 group">
            Get Started
  ...
  const plans = [
    {
      ...
      price: "$0",
      period: "/month",
      features: ["5 Scans per day", "Basic Macro Breakdown", "7-day History", "Community Support"],
      cta: "Start Free",
      highlight: false
    },
    {
      ...
      price: "$29",
      period: "/month",
      features: ["Unlimited Scans", "Micronutrient Analysis", "Export to CSV/PDF", "Priority Support", "Meal Recommendations"],
      cta: "Go Pro",
      highlight: true
    },
    {
      ...
      price: "Custom",
      period: "",
      features: ["API Access", "Custom Integration", "Dedicated Account Manager", "SLA Guarantee"],
      cta: "Contact Sales",
      highlight: false
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan, idx) => (
            ...
            >
              {plan.highlight && (
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-brand-cyan text-black text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                  Most Popular
                </div>
              )}
...
const FoodAnalyzer = () => {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const foodName = identifyResponse.text.trim();
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-gray-500 truncate">
                      {item.timestamp?.toDate ? new Date(item.timestamp.toDate()).toLocaleTimeString() : 'Just now'}
                    </p>
                  </div>
                </div>
